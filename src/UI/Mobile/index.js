        ...
        return (
            <div className={this.props.className}>
                ...
                <div className="flex justify-center">
                    <div className="block container bgContainer my-24 border">
                        <div className="flex justify-center">
                            <select className="border border-gray-300 text-white text-sm focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 bgGray w-full mx-9 md:mx-10 my-10" onChange={this.changeFrame.bind(this)}>
